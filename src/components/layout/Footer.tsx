        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              {/* Twitter/X */}
              <a href="#" className="w-9 h-9 bg-neutral-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors cursor-pointer min-w-[44px] min-h-[44px]">
