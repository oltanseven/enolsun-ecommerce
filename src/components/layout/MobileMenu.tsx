      ...
      >
        ...
        <div className="p-4 border-b border-neutral-100">
          <div className="relative">
            ...
            <input type="text" aria-label="Urun ara" placeholder="Urun ara..." className="w-full pl-10 pr-4 py-3 bg-neutral-50 border border-neutral-100 rounded-xl text-sm text-neutral-700 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-300 transition-all" />
          </div>
        </div>
