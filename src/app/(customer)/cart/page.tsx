      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          <div className="lg:col-span-2 space-y-3 sm:space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-2xl border border-neutral-100 p-3 sm:p-4 md:p-6 shadow-align-xs">
                <div className="flex gap-3 sm:gap-4">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 rounded-xl bg-neutral-200 animate-pulse flex-shrink-0" />
                  <div className="flex-1 space-y-3">
                    <div className="h-4 w-3/4 bg-neutral-200 rounded animate-pulse" />
                    <div className="h-3 w-1/2 bg-neutral-200 rounded animate-pulse" />
                    <div className="flex justify-between items-end mt-4">
                      <div className="h-9 w-28 bg-neutral-200 rounded-xl animate-pulse" />
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-4 sm:p-6">
              <div className="h-6 w-32 bg-neutral-200 rounded animate-pulse mb-5" />
        ...
        <div className="mb-6 sm:mb-8 animate-fade-in-up">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="flex items-center gap-3">
              ...
              <span className="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-primary-100 text-primary-700">{count} ürün</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-3 sm:space-y-4">
            {items.map((item) => {
              ...
              const imageUrl = primaryImage(item.product?.product_images);
                    ...
                    <Link href={`/product/${item.product?.slug}`} className="w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 rounded-xl overflow-hidden flex-shrink-0 relative">
                      {imageUrl ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-primary-100 via-primary-200 to-primary-300 flex items-center justify-center">
                          <svg className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-primary-500/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                          </svg>
                        </div>
                      )}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                          <Link href={`/product/${item.product?.slug}`}>
                            <h3 className="text-sm font-semibold text-neutral-900 truncate hover:text-primary-600 transition-colors">{item.product?.name}</h3>
                          </Link>
                      ...
                      <div className="flex items-end justify-between mt-3 sm:mt-4">
                        ...
                        <div className="text-right">
                          <p className="text-[10px] sm:text-xs text-neutral-400">Birim: {formatPrice(unitPrice)}</p>
                          <p className="text-sm sm:text-base font-bold text-neutral-900">{formatPrice(unitPrice * item.quantity)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-4 sm:p-6 lg:sticky lg:top-24 animate-scale-in">
              ...
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                ...
                <span className="text-xl font-bold text-neutral-900">{formatPrice(grandTotal)}</span>
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white/80 backdrop-blur-xl border-t border-neutral-100 px-4 py-3">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-lg font-bold text-neutral-900">{formatPrice(grandTotal)}</p>
          </div>
