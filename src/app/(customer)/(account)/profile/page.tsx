  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-5 sm:p-6">
        <h2 className="text-base font-bold text-neutral-900 mb-5">Kisisel Bilgiler</h2>
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs font-medium text-neutral-500 mb-1.5">Dogum Tarihi</label>
      ...
      {/* Password Change */}
      <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-5 sm:p-6">
        <h2 className="text-base font-bold text-neutral-900 mb-5">Sifre Degistir</h2>
        <div className="space-y-4 max-w-md">
          <div>
            <label className="block text-xs font-medium text-neutral-500 mb-1.5">Mevcut Sifre</label>
          ...
          <div>
            <label className="block text-xs font-medium text-neutral-500 mb-1.5">Yeni Sifre</label>
            <input type="password" className="w-full px-3 py-2.5 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-300 transition-all" />
          </div>
          <div>
            <label className="block text-xs font-medium text-neutral-500 mb-1.5">Yeni Sifre (Tekrar)</label>
            <input type="password" className="w-full px-3 py-2.5 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-300 transition-all" />
          </div>
          <button className="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-xl transition-colors">Sifreyi Guncelle</button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-5 sm:p-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl border-2 border-primary-500 bg-primary-25 relative">
            <span className="absolute top-2 right-2 text-[10px] font-semibold text-primary-700 bg-primary-100 px-2 py-0.5 rounded-full">Varsayilan</span>
            ...
            <div className="flex gap-3 mt-3">
              <button className="text-xs font-medium text-primary-600 hover:text-primary-700">Duzenle</button>
          ...
          <div className="p-4 rounded-xl border border-neutral-200">
            <p className="text-sm font-semibold text-neutral-800 mb-1">Is Adresi</p>
      ...
      <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-5 sm:p-6">
        ...
        <div className="space-y-4">
          {[
            { key: "email" as const, label: "E-posta Bildirimleri", desc: "Kampanya ve siparis bildirimleri" },
            { key: "sms" as const, label: "SMS Bildirimleri", desc: "Kargo ve siparis guncellemeleri" },
            { key: "push" as const, label: "Push Bildirimleri", desc: "Anlik bildirimler" },
          ].map((n) => (
