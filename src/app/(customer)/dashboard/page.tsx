...
const recommendations = [
  { name: "Dogal Tas Difuzor", price: 349, gradient: "from-teal-200 to-cyan-300" },
  { name: "Pamuk Orgu Battaniye", price: 1199, gradient: "from-violet-200 to-purple-300" },
  { name: "Ahsap Kesme Tahtasi", price: 279, gradient: "from-amber-200 to-yellow-300" },
  { name: "Aromatik Mum Seti", price: 209, gradient: "from-orange-200 to-red-200" },
];

const searchTrends = [
  { term: "Bambu lamba", searches: "2.4K" },
  { term: "Organik bakim", searches: "1.8K" },
  { term: "Seramik vazo", searches: "1.5K" },
  { term: "Dogal sabun", searches: "1.2K" },
  { term: "LED aydinlatma", searches: "980" },
];
    ...
    <div className="pt-4 sm:pt-8 pb-20 md:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 animate-fade-in-up">
          <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 mb-1">Hosgeldin, Emre!</h1>
          <p className="text-sm text-neutral-400">Hesabinizi ve siparislerinizi buradan yonetebilirsiniz.</p>
        </div>

        {/* Quick Stats */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 mb-8">
          {[
            { label: "Toplam Siparis", value: "12", icon: <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />, color: "bg-primary-50 text-primary-500" },
            { label: "Aktif Siparis", value: "1", icon: <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />, color: "bg-blue-50 text-blue-500" },
            ...
            { label: "Kuponlarim", value: "3", icon: <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />, color: "bg-yellow-50 text-yellow-600" },
          ].map((stat, i) => (
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-5 sm:p-6">
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-base font-bold text-neutral-900">Son Siparisler</h2>
                <Link href="/orders" className="text-sm font-medium text-primary-600 hover:text-primary-700 transition-colors">Tumu</Link>
              </div>
          ...
          <div>
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-align-sm p-5 sm:p-6">
              <h2 className="text-base font-bold text-neutral-900 mb-5">Trend Aramalar</h2>
              <div className="space-y-3">
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-lg font-bold text-neutral-900">Size Ozel Oneriler</h2>
            <Link href="/products" className="text-sm font-medium text-primary-600 hover:text-primary-700 transition-colors">Tumu</Link>
          </div>
