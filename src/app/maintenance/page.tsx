  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 flex items-center justify-center p-4">
      <div className="max-w-lg w-full text-center">
        ...
        <p className="text-base sm:text-lg text-primary-200 mb-10 max-w-md mx-auto leading-relaxed">
          EN dogal, EN surdurulebilir, EN yenilikci urunlerle dolu platformumuz uzerinde calisiyoruz.
        </p>

        {/* Stats */}
        <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-10 max-w-sm mx-auto">
          {[
            { val: '50+', label: 'Urun' },
            { val: '8', label: 'Kategori' },
            { val: '%100', label: 'Dogal' },
          ].map((s) => (
            <div key={s.label} className="bg-white/10 backdrop-blur-sm rounded-2xl p-3 sm:p-4 border border-white/10">
              <div className="text-2xl sm:text-3xl font-bold text-white">{s.val}</div>
              <div className="text-[11px] sm:text-xs text-primary-200 mt-1">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        {/* Social Links */}
        <div className="flex items-center justify-center gap-3 mb-8">
          <a href="https://instagram.com/enolsun" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors border border-white/10 min-w-[44px] min-h-[44px]">
          ...
          <a href="https://twitter.com/enolsun" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors border border-white/10 min-w-[44px] min-h-[44px]">
          ...
          <a href="https://youtube.com/@enolsun" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors border border-white/10 min-w-[44px] min-h-[44px]">
