...
export default function SellerSettingsPage() {
  ...
  const [storeName, setStoreName] = useState("Yesil Yaprak Atolye")
  const [storeDesc, setStoreDesc] = useState("El yapimi, dogal ve surdurulebilir ev dekorasyon urunleri.")
  const [storePhone, setStorePhone] = useState("0532 123 45 67")
  const [storeEmail, setStoreEmail] = useState("info@yesilyaprak.com")
  const [storeAddress, setStoreAddress] = useState("Kadikoy, Istanbul")
  ...
  return (
    <>
      <h1 className="text-2xl font-bold text-neutral-800 mb-6">Magaza Ayarlari</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button className="px-4 py-2 border border-neutral-200 rounded-xl text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-colors">Logo Degistir</button>
                </div>
              </div>
            </div>
          </div>
