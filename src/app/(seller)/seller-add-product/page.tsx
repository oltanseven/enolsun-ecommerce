...
export default function SellerAddProductPage() {
  ...
  useEffect(() => { document.title = "Yeni Ürün Ekle | enolsun.com Satıcı Merkezi" }, [])
    ...
    <>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-neutral-800">Yeni Ürün Ekle</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-24">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-neutral-100 shadow-align-xs p-6">
            <h2 className="text-base font-semibold text-neutral-900 mb-4 flex items-center gap-2">
              ...
              Temel Bilgiler — EN Detaylı Ürün Sayfası, EN Çok Satan Ürün Olsun!
            </h2>
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">Ürün Adı <span className="text-error-base">*</span></label>
                <input type="text" value={productName} onChange={(e) => { setProductName(e.target.value); setSlug(generateSlug(e.target.value)) }} placeholder="Ürün adını girin" className="block w-full rounded-xl border border-neutral-200 bg-white py-3 px-4 min-h-[48px] text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300" />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input type="text" value={sku} onChange={(e) => setSku(e.target.value)} placeholder="Ürün kodu" className="block w-full rounded-xl border border-neutral-200 bg-white py-3 px-4 min-h-[48px] text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300" />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">Ürün Açıklaması <span className="text-error-base">*</span></label>
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} rows={6} placeholder="Ürün hakkında detaylı açıklama yazın..." className="block w-full rounded-xl border border-neutral-200 bg-white py-3 px-4 text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300 resize-none"></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-neutral-100 shadow-align-xs p-6">
            ...
            <div className="upload-zone border-neutral-200 rounded-xl p-8 text-center cursor-pointer" onClick={() => document.getElementById("product-images")?.click()}>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-xs text-neutral-300">PNG, JPG (maks. 5MB, EN fazla 8 görsel — EN kaliteli fotoğraflar EN çok satar!)</p>
              </div>
            </div>
            {images.length > 0 && (
          ...
          <div className="bg-white rounded-xl border border-neutral-100 shadow-align-xs p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">Satış Fiyatı <span className="text-error-base">*</span></label>
              ...
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">İndirimli Fiyat</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm text-neutral-400">&#8378;</span>
          ...
          <div className="bg-white rounded-xl border border-neutral-100 shadow-align-xs p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">Ağırlık (kg)</label>
            ...
            <div className="space-y-3">
              {variants.map((v, i) => (
                <div key={i} className="flex items-center gap-3">
                  <input type="text" value={v.name} onChange={(e) => { const nv = [...variants]; nv[i].name = e.target.value; setVariants(nv) }} placeholder="Özellik (örn: Renk)" className="flex-1 rounded-xl border border-neutral-200 bg-white py-2.5 px-4 text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300" />
                  <input type="text" value={v.values} onChange={(e) => { const nv = [...variants]; nv[i].values = e.target.value; setVariants(nv) }} placeholder="Değerler (örn: Kırmızı, Mavi)" className="flex-1 rounded-xl border border-neutral-200 bg-white py-2.5 px-4 text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300" />
                  {variants.length > 1 && (
          ...
          <div className="bg-white rounded-xl border border-neutral-100 shadow-align-xs p-6">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">SEO Başlığı</label>
                <input type="text" value={seoTitle} onChange={(e) => setSeoTitle(e.target.value)} placeholder="Arama motorlarında görünecek başlık" className="block w-full rounded-xl border border-neutral-200 bg-white py-3 px-4 min-h-[48px] text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300" />
                <p className="text-xs text-neutral-300">{(seoTitle || productName).length}/60 karakter</p>
              </div>
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-neutral-700">SEO Açıklaması</label>
                <textarea value={seoDesc} onChange={(e) => setSeoDesc(e.target.value)} rows={3} placeholder="Arama motorlarında görünecek açıklama" className="block w-full rounded-xl border border-neutral-200 bg-white py-3 px-4 text-sm text-neutral-800 placeholder:text-neutral-300 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 hover:border-neutral-300 resize-none"></textarea>
                <p className="text-xs text-neutral-300">{seoDesc.length}/160 karakter</p>
              </div>
              {/* SEO Preview */}
              <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-100">
                <p className="text-xs text-neutral-400 mb-2">Arama Motoru Önizleme</p>
                <p className="text-blue-700 text-base font-medium truncate">{seoTitle || productName || "Ürün Adı"}</p>
                <p className="text-green-700 text-xs mt-0.5">enolsun.com/urun/{slug || "urun-adi"}</p>
                <p className="text-sm text-neutral-600 mt-1 line-clamp-2">{seoDesc || description || "Ürün açıklaması burada görünecek..."}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-neutral-100 shadow-align-xs p-5">
            <h3 className="text-sm font-semibold text-neutral-900 mb-3">Yayın Durumu</h3>
          ...
          <div className="bg-primary-25 border border-primary-100 rounded-xl p-5">
            <h3 className="text-sm font-semibold text-primary-800 mb-2">Hızlı Bilgi</h3>
            <ul className="space-y-2 text-xs text-primary-700">
              <li className="flex items-start gap-2">
                ...
                EN az 3 görsel yükleyin
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-3.5 h-3.5 text-primary-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Detaylı açıklama satışları artırır
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-3.5 h-3.5 text-primary-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                SEO ayarlarını doldurun
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:left-64 bg-white border-t border-neutral-100 px-4 lg:px-8 py-3 z-20">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/seller-products" className="text-sm text-neutral-500 hover:text-neutral-700 transition-colors">İptal</Link>
          <div className="flex items-center gap-3">
            ...
            <button className="px-5 py-2.5 bg-primary-500 text-white rounded-xl text-sm font-semibold hover:bg-primary-600 shadow-md shadow-primary-500/20 transition-all">Ürünü Yayınla</button>
          </div>
        </div>
      </div>
    </>
