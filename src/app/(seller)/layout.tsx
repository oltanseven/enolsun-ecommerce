...
const navItems = [
  ...
  { href: "/seller-orders", label: "Siparişler", icon: <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>, badge: "12" },
...
const bottomLinks = [
  { href: "#", label: "Yardım Merkezi", icon: <><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3M12 17h.01"/></> },
  { href: "/store/yesil-yaprak-atolye", label: "Mağazayı Görüntüle", icon: <path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6v6M10 14L21 3"/>, external: true },
]
        ...
        <div className="p-4 border-b border-neutral-100">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-neutral-900 truncate">Yeşil Yaprak Atölye</p>
                ...
                {avatarMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-align-lg border border-neutral-100 py-2 z-50">
                    <div className="px-4 py-2 border-b border-neutral-100">
                      <p className="text-sm font-semibold text-neutral-900">Yeşil Yaprak Atölye</p>
