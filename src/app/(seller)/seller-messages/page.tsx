...
const conversations = [
  { id: 1, name: "Ayse Yilmaz", initials: "AY", color: "bg-blue-100 text-blue-600", lastMsg: "Makrome duvar susu ne zaman kargoya verilir?", time: "2 dk", unread: 2, online: true },
  { id: 2, name: "Mehmet Kaya", initials: "MK", color: "bg-green-100 text-green-600", lastMsg: "Bambu lamba icin farkli renk secenegi var mi?", time: "15 dk", unread: 1, online: true },
  { id: 3, name: "Zeynep Demir", initials: "ZD", color: "bg-purple-100 text-purple-600", lastMsg: "Siparis numaram #ENS-10244, kargo takip no?", time: "1 sa", unread: 0, online: false },
  { id: 4, name: "Emre Can", initials: "EC", color: "bg-orange-100 text-orange-600", lastMsg: "Tesekkur ederim, harika bir urun!", time: "3 sa", unread: 0, online: false },
  { id: 5, name: "Selin Aksoy", initials: "SA", color: "bg-pink-100 text-pink-600", lastMsg: "Iade islemi ne kadar suruyor?", time: "1 gun", unread: 0, online: false },
]

const messages = [
  { id: 1, sender: "customer", text: "Merhaba, makrome duvar susu ne zaman kargoya verilecek?", time: "14:22" },
  { id: 2, sender: "customer", text: "Siparis numaram #ENS-10247", time: "14:22" },
  { id: 3, sender: "seller", text: "Merhaba Ayse Hanim, siparisinis bugun hazirlanacak ve yarin kargoya verilecektir.", time: "14:25" },
  { id: 4, sender: "customer", text: "Tesekkur ederim, hangi kargo firmasi ile gonderiyorsunuz?", time: "14:30" },
  { id: 5, sender: "seller", text: "Yurtici Kargo ile gonderiyoruz. Kargo takip numarasi SMS ile bildirilecektir.", time: "14:32" },
]

const quickReplies = [
  "Siparisinis hazirlaniyor, en kisa surede kargoya verilecektir.",
  "Kargo takip numaraniz SMS ile bildirilecektir.",
  "Iade islemi icin lutfen siparis detay sayfasindan basvuru yapin.",
  "Sorununuz en kisa surede cozulecektir.",
]
      ...
      <div className="flex h-full bg-white rounded-2xl border border-neutral-100 shadow-align-xs overflow-hidden">
        ...
        <div className={`w-full md:w-80 lg:w-96 border-r border-neutral-100 flex flex-col ${showMobileChat ? "hidden md:flex" : "flex"}`}>
          <div className="p-4 border-b border-neutral-100">
            <h2 className="text-lg font-bold text-neutral-900 mb-3">Mesajlar</h2>
        ...
        <div className={`flex-1 flex flex-col ${!showMobileChat ? "hidden md:flex" : "flex"}`}>
          ...
          <div className="flex items-center justify-between p-4 border-b border-neutral-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-success-base">{activeContact?.online ? "Cevrimici" : "Cevrimdisi"}</p>
              </div>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-neutral-25">
            <div className="text-center"><span className="text-xs text-neutral-400 bg-white px-3 py-1 rounded-full">Bugun</span></div>
            {msgList.map(msg => (
